...
public class AddressBook extends JFrame implements ActionListener{
	...
	private JPanel contactInfoPanel = new JPanel();
	private JPanel optionsPanel = new JPanel(); 
	private JPanel savedContactsPanel = new JPanel();
	...
	public AddressBook() {
		...
		contactInfoPanel.setLayout(new GridLayout(4, 2));
		contactInfoPanel.setBorder(new TitledBorder(new EtchedBorder(), "Enter New Contact Information"));
		optionsPanel.setBorder(new TitledBorder(new EtchedBorder(), "Add New Contact or Save to File"));
		savedContactsPanel.setBorder(new TitledBorder(new EtchedBorder(), "Saved Contacts"));
		...
		contactInfoPanel.add(textFieldName);
		contactInfoPanel.add(labelName);
		contactInfoPanel.add(textFieldName);
		contactInfoPanel.add(labelAddress);
		contactInfoPanel.add(textFieldAddress);
		contactInfoPanel.add(labelPhone);
		contactInfoPanel.add(textFieldPhone);
		contactInfoPanel.add(labelEmail);
		contactInfoPanel.add(textFieldEmail);
		optionsPanel.add(buttonAddContact);
		optionsPanel.add(buttonSaveToFile);
		savedContactsPanel.add(textArea);
		
		// add panel to the JFrame
		add(contactInfoPanel, BorderLayout.NORTH);
		add(optionsPanel, BorderLayout.CENTER);
		add(savedContactsPanel, BorderLayout.SOUTH);
